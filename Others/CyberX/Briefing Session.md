...
The introduction to CTF showed me how cybersecurity skills can be applied in a practical and competitive environment. Besides that, the basics of web exploitation helped me understand how real-world vulnerabilities are found and exploited. In my opinion, the reverse engineering sharing session was the most interesting part, because it showed how programs react from a level beyond source codes.  

Overall, this session enhanced my motivation to continue learning cybersecurity step by step. Now, I feel more confident to explore into beginners' CTFs and participate in upcoming workshops. I am excited for the journey ahead and looking forward to build my skills through practice and challenges.
