...
- **2023 | IT Intern**  
  - 1-year internship under the Data Analytics Department
...
Once the ingredients are received by the restaurant, they are stored in a freezer, which represents storage systems such as local databases and data warehouses. Next, baking appliances represent hardware, including servers and cloud computing. Every restaurant has its own recipe, and the recipe book represents software such as Power BI, which is used to process and document the data. The chef represents the BI developer that builds reports and dashboards. They transform raw data into tables and charts. Finally, the customer represents business users who request and view these reports.

Moreover, the speaker also mentioned that Power BI is not just a software application, it is a platform that can connect to many different data sources. It has three main components: Power BI Desktop, Power BI Service, and Power BI Mobile. She also showed us an incomplete system architecture to explain how data flows into Power BI and how to modify the VPN to ensure that the right people view the right information.
...
<img width="977" height="480" alt="Screenshot 2026-01-14 102040" src="https://github.com/user-attachments/assets/3c7e80bb-e847-4756-9485-dadd649b6659" />
